  ...
  return (
      <Router>
        <Switch>
          ...
          <Route path='/light' exact component={HomeLight} />
          <Route path='/about-light' component={AboutLight} />
          <Route path='/experience-light' component={ExperienceLight} />
          <Route path='/education-light' component={EducationLight} />
